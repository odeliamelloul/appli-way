       ...
       <div className=" d-flex Contact">
        <div className="contactUsIcon d-flex flex-column"> 
          ...
          <form className=" d-flex flex-column formContactUs">
            ...
            <input type="text" ref={this.name} onChange={this.nameChange} placeholder="שם מלא" />
            ...
            <textarea name="" id="" placeholder="הודעה" ></textarea>
            <button type="submit" onClick={this.submitForm} >שלח</button>
            {this.state.isSubmit && <h2>נשלח בהצלחה</h2> }
        </form>
